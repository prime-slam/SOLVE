...
object LineFactory : LandmarkFactory<StorageLine, SceneLine, Layer.LineLayer> {
    override fun buildLandmark(storageFormatLandmark: StorageLine, containingLayer: Layer.LineLayer): SceneLine {
