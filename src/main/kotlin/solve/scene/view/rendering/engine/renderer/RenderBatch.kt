package solve.scene.view.rendering.engine.renderer
...
import solve.scene.view.rendering.engine.jade.Scene
...
class RenderBatch(maxBatchSize: Int) {
    ...
    init {
        shader = AssetPool.getShader("openGlResources/shaders/default.glsl")
